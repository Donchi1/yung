...
function Services() {
  return (
    <section className="w-full bg-sec-bg pt-20 pb-20">
      <div
        data-aos="fade-up"
        data-aos-duration="3000"
        className="my-container "
      >
        <Text className="title mb-4 text-center lg:text-left">
          Our Services
        </Text>
        <div
          data-aos="fade-down"
          data-aos-duration="3000"
          className="flex lg:justify-between gap-y-6 justify-center lg:flex-row flex-col items-center lg:items-start "
        >
          <div className="flex-1">
            <Text className="head text-center lg:text-left">
              We Help Transport Your Future
            </Text>
          </div>
