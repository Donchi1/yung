    ...
    <>
        ...
        <div className="w-[90%] mx-auto">
          <div className="flex flex-col lg:flex-row mt-10 lg:mt-0  items-center justify-center h-auto lg:h-[95vh]">
            ...
            >
              ...
              <Text className="text-[3rem] lg:text-[5rem] leading-tight">
                Get Your Load to Market Faster
              </Text>
              <Text className="!text-light-color/70">
                Get your goods and products to any country with ease.
                <br />
                Global delivery issues solved with the Yung global.
              </Text>
            ...
            <div data-aos="fade-left" data-aos-duration="3000" className="">
              <Image
                className="w-[900px]"
                alt="container"
                src={"/imgs/shipping-Container-hook.png"}
                width={600}
                height={600}
              />
            </div>
      ...
      <section className="w-full lg:-mt-6 mt-0 h-screen lg:h-auto mb-20">
        <div
          data-aos="fade-up"
          data-aos-duration="3000"
          className="w-[90%] -z-10 h-screen lg:h-[80vh] mx-auto relative bg-no-repeat bg-cover bg-center"
          style={{ backgroundImage: "url(/imgs/ship_container_in_sea.jpg)" }}
        >
          <div
            data-aos="fade-up"
            data-aos-duration="3000"
            className="bg-primary-color flex justify-center items-center absolute bottom-0 px-8 py-4  w-[80%]"
          >
