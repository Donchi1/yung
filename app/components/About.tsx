        ...
        <div className="flex items-center gap-y-10 lg:flex-row flex-col justify-between relative min-h-screen">
          <div className="flex-1 ">
            <Image
              ...
              className="h-[600px]"
              src={"/imgs/cargo-ship-from-top.jpg"}
              height={900}
              width={500}
              alt="about-ship"
            />
            <div
              data-aos="fade-up"
              data-aos-duration="3000"
              className="absolute hidden lg:block -bottom-32"
            >
              <Image
          ...
          >
            ...
            <Text>
              Experience the difference with Yung Global Logistics where
            ...
            <div className="flex gap-4 divide-x-0 lg:divide-x divide-y lg:divide-y-0  divide-light-color/30 lg:flex-row flex-col">
              ...
              >
                ...
                <Text>
                  At Yung Global Logistics, our vision is to redefine the future
                  of transportation and supply chain management, setting new
              ...
              <div
                data-aos="fade-left"
                data-aos-duration="3000"
                className="space-y-4  flex-1 pl-0 lg:pl-6"
              >
                ...
                <Text>
                  Our mission at Yung Global Logistics is to empower businesses
                  to thrive in an interconnected world by providing seamless
                  logistics solutions...
                </Text>
              </div>
            </div>
