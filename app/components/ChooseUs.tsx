          ...
          <div className="flex gap-6 items-center flex-col lg:flex-row">
            <div className="space-y-8 lg:text-right text-left">
              ...
              >
                ...
                <Text className="!text-light-color/70">
                  Ensure your goods arrive intact with our rigorous packaging
                  standards.
                </Text>
              </div>
              <div
              ...
              >
                <div className="flex justify-start lg:justify-end">
                  <BsGlobeCentralSouthAsia
                    size={40}
                    className="text-primary-color !text-right"
                  />
                </div>

                <Text className="!text-[1.5rem]">Global Shipping</Text>
                <Text className="!text-light-color/70">
                  Expand your reach with seamless shipping solutions tailored to
                  your needs.
                </Text>
              </div>
            </div>
            <div data-aos="fade-up" data-aos-duration="3000">
              <Image
                height={800}
                width={500}
                alt="container-ship-carrying"
                src={"/imgs/container-ship-carrying.jpg"}
              />
            </div>
            <div className="space-y-8">
              ...
              >
                ...
                <Text className="!text-light-color/70">
                  Stay on schedule with our efficient logistics network and
              ...
              >
                ...
                <Text className="!text-light-color/70">
                  Save without sacrificing quality through our optimized
                  logistics and competitive rates.
                </Text>
              </div>
            </div>
          </div>
